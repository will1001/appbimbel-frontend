...
const DashboardHomeSoal = React.lazy(() => import('./App/components/HomeSoal'));
const DashboardAddSoal = React.lazy(() => import('./App/components/AddForm'));
const DashboardEditSoal = React.lazy(() => import('./App/components/EditForm'));
const DashboardReviewSoal = React.lazy(() => import('./App/components/Review'));
const DashboardQuiz = React.lazy(() => import('./App/components/Quiz'));
const DashboardTryOut = React.lazy(() => import('./App/components/TryOut'));
const DashboardPaketSoal = React.lazy(() => import('./App/components/PaketSoal'));
const DashboardIsiSoal = React.lazy(() => import('./App/components/IsiSoal'));
const DashboardOthers = React.lazy(() => import('./App/components/Others'));
const DashboardSubBabSoal = React.lazy(() => import('./App/components/SubBabSoal'));
const DashboardKonsepSoal = React.lazy(() => import('./App/components/KonsepSoal'));
const DashboardUTBK = React.lazy(() => import('./App/components/UTBK'));
const DashboardSlideContent = React.lazy(() => import('./App/components/SlideContent'));
const DashboardPaketApp = React.lazy(() => import('./App/components/PaketApp'));
const DashboardTransaksi = React.lazy(() => import('./App/components/TransactionHistory'));
const DashboardBantuan = React.lazy(() => import('./App/components/Bantuan'));
...
const routes = [
    ...
    { path: '/dashboard/HomeSoal', exact: true, name: 'Soal', component: DashboardHomeSoal },
    { path: '/dashboard/AddSoal', exact: true, name: 'Tambah Soal', component: DashboardAddSoal },
    { path: '/dashboard/EditSoal/:id', exact: true, name: 'Edit Soal', component: DashboardEditSoal },
    { path: '/dashboard/Materi', exact: true, name: 'Review', component: DashboardReviewSoal },
    { path: '/dashboard/Quiz', exact: true, name: 'Quiz', component: DashboardQuiz },
    { path: '/dashboard/TryOut', exact: true, name: 'TryOut', component: DashboardTryOut },
    { path: '/dashboard/PaketSoal', exact: true, name: 'PAket Soal', component: DashboardPaketSoal },
    { path: '/dashboard/Others', exact: true, name: 'Others', component: DashboardOthers },
    { path: '/dashboard/SubBabSoal', exact: true, name: 'Sub Bab Soal', component: DashboardSubBabSoal },
    { path: '/dashboard/KonsepSoal', exact: true, name: 'Konsep Soal', component: DashboardKonsepSoal },
    { path: '/dashboard/UTBK', exact: true, name: 'UTBK', component: DashboardUTBK },
    { path: '/dashboard/IsiSoal', exact: true, name: 'IsiSoal', component: DashboardIsiSoal },
    { path: '/dashboard/SlideContent', exact: true, name: 'Slide Content', component: DashboardSlideContent },
    { path: '/dashboard/PaketApp', exact: true, name: 'Paket', component: DashboardPaketApp },
    { path: '/dashboard/Transaksi', exact: true, name: 'Transaksi', component: DashboardTransaksi },
    { path: '/dashboard/Bantuan', exact: true, name: 'Bantuan', component: DashboardBantuan },
