...
function KonsepSoal(props) {
    ...
    const addData = () => {
        const data ={
            nomor : konsepSoal.length+1,
            deskripsi : deskripsi,
            id_sub_bab:selectSubBabSoal
        }
        
        axios.post('/konsep_soal', data)
    ...
    const mainPanel =
        <>
            ...
            <Table
                ...
                thList={["no", "Deskripsi","Sub Bab", "Action"]}
                tdList={konsepSoal.map((item,index) => (
