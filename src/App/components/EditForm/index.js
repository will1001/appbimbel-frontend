...
function EditForm(props) {
    ...
    const addData = (e) => {
        ...
        setTimeout(function () { window.location = "https://will1001.github.io/appbimbel-frontend/"; }, 3000);
        ...
        async function fetchdata() {
            ...
            axios.get('/bank_soal?id=' + id)
                .then(function (response) {
                    ...
                    setKategoriSoal(resSoal.kategori_soal);
                    setSelectUtbk(resSoal.id_utbk);
                    setTahunSoal(resSoal.tahun_soal+"-01-01")
                    ...
                    // if (resSoal.tipe_soal === "pilgan") {
                        setPil_a(resSoal.pil_a);
                        setPil_b(resSoal.pil_b);
                        setPil_c(resSoal.pil_c);
                        setPil_d(resSoal.pil_d);
                        setPil_e(resSoal.pil_e);
                    // }
